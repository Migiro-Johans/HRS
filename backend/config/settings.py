"""
Django settings for HRS (HR System) project.
Payroll and Leave Management System for House of Procurement Limited
"""
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'HRS - Payroll & Leave Management API',
    'DESCRIPTION': 'API for House of Procurement Limited HR System',
    'VERSION': '1.0.0',
...
AZURE_STORAGE_CONTAINER = config('AZURE_STORAGE_CONTAINER', default='hrs-documents')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@houseofprocurement.com')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'hrs.log',
            'formatter': 'verbose',
        },
    },
    'root': {
